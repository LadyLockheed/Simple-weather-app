...
//! PostalWeather Area Start
    ...
    sendBtn.addEventListener('click', async e => {
		...
		console.log("Vad som kommer från api: ",responseData)
		console.log("inne på days listan: ", responseData.Days[0]);
		let weatherArray = responseData.Days[0];
		let wx_code=responseData.Days[0].Timeframes[0].wx_code;
		console.log("DEtta är koden:", wx_code);
        console.log("detta är arrayen för första dagen: ",weatherArray);
...
function umbrellaOrNot(wx_code) {
    ...
    //     umbrellaYesNo(weatherArray, postalCode)
	// }
